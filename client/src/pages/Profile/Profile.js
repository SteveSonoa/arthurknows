						...
						<Col size="lg-12 md-12 sm-12 xs-12">
							...
							<form className="form-horizontal">
								<div className="form-group col-xs-9 col-sm-9 col-md-9 col-lg-9">
									...
									<input type="text" className="form-control" id="firstName" defaultValue={this.props.profileData.firstName} placeholder="First Name" />
								</div>
								<div className="form-group col-xs-9 col-sm-9 col-md-9 col-lg-9">
									<label for="firstName">Last Name</label>
									<input type="text" className="form-control" id="lastName" defaultValue={this.props.profileData.lastName} placeholder="Last Name" />
								</div>
