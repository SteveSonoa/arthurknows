...
import { Personal07, Headlines, Twitter } from "../../components/Results";
import "./Results.css";
...
class Results07 extends React.Component {
							...
							<Container fluid>
								<Row>
									<Col size="lg-3 md-3 sm-3 xs-12">
										<img className="img img-responsive img-circle center-block" src={peopleData[6].image || "/img/noPic.png"} alt={peopleData[6].firstName} />
									</Col>
									<Col size="lg-9 md-9 sm-9 xs-12">
										<h1>{peopleData[6].firstName} {peopleData[6].lastName}</h1>
										<a href={peopleData[6].linkedin}>{peopleData[6].linkedin}</a>
										<p>{peopleData[6].title}</p>
										<p>{peopleData[6].company}</p>
									</Col>
								</Row>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										<p>{peopleData[6].description}</p>
									</Col>
								</Row>
					...
					<Row>
						<Col size="lg-5 md-5 sm-12 xs-12">
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										{ peopleData[6].twitter.map(tweet => (
							...
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										...
										{peopleData[6].headlines.map(story => (
