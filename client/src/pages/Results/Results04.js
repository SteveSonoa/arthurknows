...
import { Personal04, Headlines, Twitter } from "../../components/Results";
import "./Results.css";
...
class Results04 extends React.Component {
							...
							<Container fluid>
								<Row>
									<Col size="lg-3 md-3 sm-3 xs-12">
										<img className="img img-responsive img-circle center-block" src={peopleData[3].image || "/img/noPic.png"} alt={peopleData[3].firstName} />
									</Col>
									<Col size="lg-9 md-9 sm-9 xs-12">
										<h1>{peopleData[3].firstName} {peopleData[3].lastName}</h1>
										<a href={peopleData[3].linkedin}>{peopleData[3].linkedin}</a>
										<p>{peopleData[3].title}</p>
										<p>{peopleData[3].company}</p>
									</Col>
								</Row>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										<p>{peopleData[3].description}</p>
									</Col>
								</Row>
					...
					<Row>
						<Col size="lg-5 md-5 sm-12 xs-12">
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										{ peopleData[3].twitter.map(tweet => (
							...
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										...
										{peopleData[3].headlines.map(story => (
