...
import { Personal05, Headlines, Twitter } from "../../components/Results";
import "./Results.css";
...
class Results05 extends React.Component {
							...
							<Container fluid>
								<Row>
									<Col size="lg-3 md-3 sm-3 xs-12">
										<img className="img img-responsive img-circle center-block" src={peopleData[4].image || "/img/noPic.png"} alt={peopleData[4].firstName} />
									</Col>
									<Col size="lg-9 md-9 sm-9 xs-12">
										<h1>{peopleData[4].firstName} {peopleData[4].lastName}</h1>
										<a href={peopleData[4].linkedin}>{peopleData[4].linkedin}</a>
										<p>{peopleData[4].title}</p>
										<p>{peopleData[4].company}</p>
									</Col>
								</Row>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										<p>{peopleData[4].description}</p>
									</Col>
								</Row>
					...
					<Row>
						<Col size="lg-5 md-5 sm-12 xs-12">
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										{ peopleData[4].twitter.map(tweet => (
							...
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										...
										{peopleData[4].headlines.map(story => (
