...
import { Personal01, Headlines, Twitter } from "../../components/Results";
import "./Results.css";
...
class Results01 extends React.Component {
							...
							<Container fluid>
								<Row>
									<Col size="lg-3 md-3 sm-3 xs-12">
										<img className="img img-responsive img-circle center-block" src={peopleData[0].image || "/img/noPic.png"} alt={peopleData[0].firstName} />
									</Col>
									<Col size="lg-9 md-9 sm-9 xs-12">
										<h1>{peopleData[0].firstName} {peopleData[0].lastName}</h1>
										<a href={peopleData[0].linkedin}>{peopleData[0].linkedin}</a>
										<p>{peopleData[0].title}</p>
										<p>{peopleData[0].company}</p>
									</Col>
								</Row>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										<p>{peopleData[0].description}</p>
									</Col>
								</Row>
					...
					<Row>
						<Col size="lg-5 md-5 sm-12 xs-12">
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										{ peopleData[0].twitter.map(tweet => (
							...
							<Container fluid>
								<Row>
									<Col size="lg-12 md-12 sm-12 xs-12">
										...
										{peopleData[0].headlines.map(story => (
